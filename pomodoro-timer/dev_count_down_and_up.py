...
class TimerScreen(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.mode_button = Button(text="Switch to Count Down", on_press=self.switch_mode)
    ...
    def update_time(self, dt):
        ...
        minutes, seconds = divmod(abs(self.time), 60)
    ...
    def switch_mode(self, instance):
        if self.mode == "count_up":
            self.mode = "count_down"
            instance.text = "Switch to Count Up"
        else:
            self.mode = "count_up"
            instance.text = "Switch to Count Down"
